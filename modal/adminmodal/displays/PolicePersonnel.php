<div class="d-flex flex-column-fluid" v-if="pageName == 'PolicePersonnel'">
 	<!--begin::Container-->
 	<div class="container-fluid">
 		<div class="row">
 			<div class="col-10">
 				<h1 class="modal-title fs-5 text-success" id="staticBackdropLabel"><b>Police Personnel</b></h1>
 			</div>
 		</div>
 			...
 			<table class="table table-bordered ">
 				<thead class="kt-table-thead text-body">
 					<tr>
						 ...
						 <th class="kt-table-cell text-center"><b>Rank</b></th>
 				...
 				<tbody class="kt-table-tbody text-dark table-group-divider">
 					<tr class="kt-table-row kt-table-row-level-0 text-info" v-for="employee,index in employees" v-if="employee.status != 2 && employee.department == 'Police Personnel'">
