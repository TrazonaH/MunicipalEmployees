	<div class="modal" id="PurchaseProducts" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	    <div class="modal-dialog modal-xl">
	        <div class="modal-content">
	            <div class='row'>
	                <div class="col-10">
	                    <h1 class="modal-title" style="font-family: 'Times New Roman', Times, serif; padding:20px;" id="exampleModalLabel">Purchase (New Item? <a href="#" data-dismiss="modal" data-toggle="modal" data-target="#PurchaseProductSupplies" style="color: green">click here)</a></h1>
	                </div>
	            </div>
	            </button>
	            <div class="container">
	                <form  @submit="purchaseItem">
	                    <div class="container-fluid">
	                        <div class="row" style="border: 1px gray">
	                            ...
	                            <div class="col-5">
	                                <select name='item' class="form-control form-control-lg" required>
	                                    <option value="">Choose Item...</option>
	                                    <option :value="product.product_id" v-for="product in products">{{product.product_name}} (Storable)</option>
										<option :value="supply.supply_id" v-for="supply in supplies">{{supply.supply_name}} (Consumable)</option>
	                                </select>
	                            </div>
	                            <div class="col-2">
	                        ...
	                        <div class="modal-footer">
	                            ...
	                            <button type="button" class="btn btn-secondary" id="closepurchaseproductModal" data-dismiss="modal">Close</button>
